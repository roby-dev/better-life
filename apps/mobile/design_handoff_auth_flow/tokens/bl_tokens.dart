...
class BLColors {
  ...
  static final lightTextMuted = lavender500.withOpacity(0.55);
  static final lightTextFaint = lavender500.withOpacity(0.40);
  static final lightBorder    = lavender500.withOpacity(0.10);
  static const lightBorderFocus = lavender400;
  static final lightIconIdle  = Color(0xFF64647A).withOpacity(0.55);
  ...
  static final lightPrimaryBgDisabled = lavender500.withOpacity(0.18);
  static final lightTrack     = lavender500.withOpacity(0.08);
  ...
  static final darkSurface        = Colors.white.withOpacity(0.04);
  static const darkText           = Color(0xFFE6E5F2);
  static final darkTextMuted      = const Color(0xFFE8E7F5).withOpacity(0.55);
  static final darkTextFaint      = const Color(0xFFE8E7F5).withOpacity(0.40);
  static final darkBorder         = lavender100.withOpacity(0.10);
  static const darkBorderFocus    = lavender200;
  static final darkIconIdle       = const Color(0xFFE8E7F5).withOpacity(0.45);
  static const darkIconFocus      = lavender100;
  static const darkPrimaryBg      = lavender100;
  static const darkPrimaryFg      = lavender500;
  static final darkPrimaryBgDisabled = lavender100.withOpacity(0.18);
  static final darkTrack          = lavender100.withOpacity(0.10);
}
